...
rule_header = re.compile(
    ...
    r"(?P<srcaddress>(\$[\w\d]+)|any|((([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5]))(\/(3[0-2]|[1-2][1-9]|[1-9]))?)\s+"  # Source address (<!>1-255.1-255.1-255.1-255/0-32 | lists of ips ex. [192.1.1.1/32,10.254.32.1/32]
    r"(?P<srcport>(\$[\w\d]+)|any|!?(([0-9]{1,4}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5])|([0-9]{1,4}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5]):|:([0-9]{1,4}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5])|([0-9]{1,4}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5]):([0-9]{1,4}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5]))?)\s+"  # Source ports (1-65535 | (1-65535|):(1-65535|) | any)
    r"(?P<direction>[-><]+)\s+"                                             # Direction <- | <> | ->
    r"(?P<dstaddress>(\$[\w\d]+)|any|((([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5]))(\/(3[0-2]|[1-2][1-9]|[1-9]))?)\s+"  # Destination address
    r"(?P<dstport>(\$[\w\d]+)|any|!?(([0-9]{1,4}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5])|([0-9]{1,4}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5]):|:([0-9]{1,4}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5])|([0-9]{1,4}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5]):([0-9]{1,4}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5]))?)\s+"  # Destination port (1-65535 | (1-65535|):(1-65535|) | any)
...
payloadDetection = {
    "content" : re.compile("content\s*:\s*\"(?P<content>.*?)\";"),
