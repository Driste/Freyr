...
rule_header = re.compile(
    ...
    r"(?P<srcaddress>any|((([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5]))(\/(3[0-2]|[1-2][1-9]|[1-9]))?)\s+"  # Source address (<!>1-255.1-255.1-255.1-255/0-32 | lists of ips ex. [192.1.1.1/32,10.254.32.1/32]
    ...
    r"(?P<dstaddress>any|((([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5]))(\/(3[0-2]|[1-2][1-9]|[1-9]))?)\s+"  # Destination address
